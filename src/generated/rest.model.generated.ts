...
export interface paths {
    ...
    "/upload/season/{seasonId}/regulation": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * @description Upload a PDF regulation file for a season.
         *
         *     File Format:
         *     - PDF file (application/pdf)
         *     - Maximum file size: 10MB
         *
         *     The file will be stored and the URL will be returned in the response.
         *     The Season's regulationFileUrl field will be automatically updated.
         */
        post: operations["uploadSeasonRegulation"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/upload/matchday/{matchdayId}/attachment": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * @description Upload a PDF attachment (e.g., written report) for a matchday.
         *
         *     File Format:
         *     - PDF file (application/pdf)
         *     - Maximum file size: 10MB
         *
         *     The file will be stored and the URL will be added to the MatchDay's reportAttachments array.
         *     Multiple attachments can be uploaded by calling this endpoint multiple times.
         */
        post: operations["uploadMatchdayAttachment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    uploadSeasonRegulation: {
        parameters: {
            query?: never;
            header?: never;
            path: {
                /** @description The ID of the season to upload the regulation for */
                seasonId: string;
            };
            cookie?: never;
        };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     * @example {
                     *       "success": true,
                     *       "fileUrl": "https://example.com/regulations/season-123-regulation.pdf"
                     *     }
                     */
                    "application/json": {
                        success: boolean;
                        /**
                         * Format: uri
                         * @description The URL where the regulation file is stored
                         */
                        fileUrl: string;
                    };
                };
    ...
    uploadMatchdayAttachment: {
        parameters: {
            query?: never;
            header?: never;
            path: {
                /** @description The ID of the matchday to upload the attachment for */
                matchdayId: string;
            };
            cookie?: never;
        };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     * @example {
                     *       "success": true,
                     *       "fileUrl": "https://example.com/attachments/matchday-456-report.pdf"
                     *     }
                     */
                    "application/json": {
                        success: boolean;
                        /**
                         * Format: uri
                         * @description The URL where the attachment file is stored
                         */
                        fileUrl: string;
                    };
                };
            ...
            404: {
                ...
                content: {
                    /**
                     * @example {
                     *       "error": "Matchday with ID '456' not found"
                     *     }
                     */
                    "application/json": {
                        error?: string;
